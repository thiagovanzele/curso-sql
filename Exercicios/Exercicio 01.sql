insert into cliente (cliente_id, nome, cpf, rg, data_nascimento, genero, profissao, nacionalidade, logradouro, numero, complemento, bairro, municipio, uf) 
	values (1, 'Manoel', '88828383121', '32323', '2001-01-30', 'M', 'Desenvolvedor', 'Brasileira', 'Rua Joaquim Nabuco', '23', 'Casa', 'Jardim Oriental', 'Santo André', 'São Paulo');

insert into cliente (cliente_id, nome, cpf, rg, data_nascimento, genero, profissao, nacionalidade, logradouro, numero, complemento, bairro, municipio, uf) 
	values (2, 'Geraldo', '98765412321', '32323-x', '2002-10-20', 'M', 'Estudante', 'Brasileira', 'Rua dos Tamancos', '18', 'Apartamento', 'Jardim Oriental', 'Santo André', 'São Paulo');
